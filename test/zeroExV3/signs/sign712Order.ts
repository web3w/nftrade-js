...
//0x7e0fc1c5e52ee978991c8efcc17b3a1ad3aa3ebba1b5dc46ec30e919228134b3
const hash = signHash()
console.log("Sign Hash:", ethUtil.bufferToHex(hash))
...
;(async ()=>{
  ...
  // })
  // // 0x7e0fc1c5e52ee978991c8efcc17b3a1ad3aa3ebba1b5dc46ec30e919228134b3
  // const orderInfo = await buyerEx.exchange.getOrderInfo(typedData.message)
  // console.log(orderInfo.orderHash)
})()
//
